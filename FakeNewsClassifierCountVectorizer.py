...
count_vector = CountVectorizer(max_features=5000, ngram_range=(1, 3))  # (1, 3) take inputs of 1/2/3 words as a feature
...
print(count_vector.get_feature_names_out()[:20])
print(count_vector.get_params())

# Show how training dataset looks like
count_df = pd.DataFrame(X_train, columns=count_vector.get_feature_names_out())
print(count_df.head())
...
confusion_m = metrics.confusion_matrix(y_test, y_prediction)
print(confusion_m)
