...
# print(hs_vectorizer.get_feature_names_out()[:20])
print(hs_vectorizer.get_params())

# Show how training dataset looks like
# count_df = pd.DataFrame(X_train, columns=hs_vectorizer.get_feature_names_out())
# print(count_df.head())
...
# Get Features names
# feature_names = hs_vectorizer.get_feature_names_out()
